      ...
      <div class="row posts" style="margin-top: 40px;">
        <div id="images" class="item new col-md-4">
            <div class="featured-item">
              <img src="https://asset.kompas.com/crops/p-lGoscbOh7DCAVHzMunqAxNCNQ=/0x253:675x703/750x500/data/photo/2021/01/30/6014da00f2716.jpeg" alt="Labu" >
            </div>
          </a>
        </div>
          ...
          <a>
            <div class="featured-item">
              <h3>Deskripsi Produk:</h3>
                    <p>Labu bukan merupakan sayuran hijau.</p>
                    <p>Dipetik langsung dari kebun.</p>
                    <p>Bebas pestisida.</p>
                    <h3>Harga Rp. 10.000,-</h3>
                    <p>Jumlah Stok : 20 Kg</p>
            </div>
          </a>
        </div>
        <div id="formedit" class="item low col-md-4">
          <a>
            <form action="#" method="POST">
              ...
              <p>Nama Barang :<input type="text" name="namaproduk" placeholder="Labu kuning"></p>
              <p>Deskripsi : <input type="text" name="deskripsi"></p>
              <p>Harga : <input type="number" name="hargabarang" placeholder="10.000"></p>
              <p>Jumlah stok : <input type="number" name="stok" placeholder="20" min="0"></p>
