      ...
      <div class="row posts" style="margin-top: 40px;">
        <div id="images" class="item new col-md-4">
            <div class="featured-item">
              <img src="https://asset.kompas.com/crops/sXTlbIkm--BJRejh3NHb3BErBds=/34x0:974x627/750x500/data/photo/2017/08/13/744710335.jpg" alt="Paprika" >
            </div>
          </a>
        </div>
          ...
          <a>
            <div class="featured-item">
              <h3>Deskripsi Produk:</h3>
                    <p>Paprika bukan merupakan sayuran hijau.</p>
        ...
        <div id="formedit" class="item low col-md-4">
          <a>
            <form action="#" method="POST">
              ...
              <p>Nama Barang :<input type="text" name="namaproduk" placeholder="Paprika"></p>
