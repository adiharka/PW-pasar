      ...
      <div class="row posts" style="margin-top: 40px;">
        <div id="images" class="item new col-md-4">
            <div class="featured-item">
              <img src="https://lifepack.id/wp-content/uploads/2020/06/5-Manfaat-Buah-Tomat-Untuk-Kesehatan-Tubuh.jpg" alt="Tomat" >
            </div>
          </a>
        </div>
          ...
          <a>
            <div class="featured-item">
              <h3>Deskripsi Produk:</h3>
                    <p>Tomat bukan merupakan sayuran hijau.</p>
        ...
        <div id="formedit" class="item low col-md-4">
          <a>
            <form action="#" method="POST">
              ...
              <p>Nama Barang :<input type="text" name="namaproduk" placeholder="Tomat"></p>
