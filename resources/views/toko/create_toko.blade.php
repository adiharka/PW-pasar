        ...
        <div class="row">
          <div class="col-md-12">
            <div class="section-heading">
              ...
              <h1 style="font-size: 30pt;">Daftarkan Toko Anda</h1>
            </div>
          </div>
          <div class="col-md-6">
            <div id="map">
              ...
              <img src="https://assets1.risnews.com/styles/content_sm/s3/2019-06/grocery%203.jpg?itok=4UCoo3jk" width="100%" height="500px" frameborder="0" align="left" style="width: 550px;height: 490px;margin-right: 100px;margin-top: 100px;"></img>
            </div>
          </div>
          <div class="col-md-6" >
            <div class="right-content" >
              <div class="container">
                ...
                <form id="contact" action="{{url('simpan_toko')}}" method="post">
                  <div class="row">
                     ...
                     <div class="form-container" style="width: margin-left: 70px;padding-bottom: 30px;>
                      ...
                      <div class="container">
                       <label for="">Nama Pemilik Toko</label>
                        <input type="text" name="nama_pemilik" placeholder="Masukkan Nama Pemilik" required autocomplete="off" autofocus>

                        <label for="">Nama Toko</label>
                        <input type="text" name="nama_toko" placeholder="Masukkan Nama Toko" required autocomplete="off" autofocus>

                        <label for="">Alamat Toko</label>
                        <input type="text" name="alamat" placeholder="Masukkan Alamat Toko" required autocomplete="off" autofocus>

                        <label for="">Nomor Telepon</label>
                        <input type="text" name="no_telp" placeholder="Masukkan Nomor Telepon Toko" required autocomplete="off" autofocus>
                        
                         <label for="">Email</label>
                        <input type="email" name="email" placeholder="Masukkan Email" required autocomplete="off">

                        <label for="">Kata Sandi</label>
                        <input type="password" name="password" placeholder="Masukkan Kata Sandi" required autocomplete="off">
                       
          
                        <button onclick="window.location.href='{{url('login_fix')}}'" class="b1">Login</button> <button onclick="window.location.href='{{url('loginToko')}}'" class="b2">Login Toko</button>  
                         
                        <button type="submit" id="form-submit" class="b3">Sign Up</button>  
