        ...
        <div class="row">
          ...
          <div class="col-md-6">
            <div class="right-content"style="margin-right: 10px;">
              <div class="container" >
                <form id="contact" action="{{route('simpan_produk')}}" method="post">
                {{csrf_field()}}
                  <div class="row">
                    <div class="col-md-12">
                      <fieldset>
                         <label for="fname"><b>Nama Produk</b></label>
                        <input name="nama_barang" type="text" class="form-control" id="nama_barang" placeholder="Nama Produk" required="">
                      </fieldset>
                    </div>
                    <div class="col-md-12">
                      <fieldset>
                    ...
                    <div class="col-md-12">
                      <fieldset>
                        <label for="Review"  style="padding-bottom: 18px;"><b>Review</b></label>
                         <textarea  name="review" type="text" id="deskripsi" false style="width : 510px;" rows="9" class="form-control"></textarea>
                      </fieldset>
                    </div>
                    <div class="col-md-12">
                      <fieldset>
                        <label for="Variasi"><b>Variasi</b></label>
                        <input name="variasi" type="text" class="form-control" id="variasi" placeholder="variasi" required="">
                      </fieldset>
                       </div>
