  ...
  <body>
    ...
    <table>
      ...
      <tr>
        ...
        <th>{{$isi->variasi}}</th>
        <th>
          <a href="{{url('edit_produk',$isi->id_barang)}}">Edit</a> | <a href="{{url('delete_produk',$isi->id_barang)}}">Hapus</a>
        </th>
      </tr>
      @endforeach
     ...
     <div ><a href="{{route('create_produk')}}" target="self"><input name="skip_Submit" value="Tambah Produk" name="tambah" type="submit" 
