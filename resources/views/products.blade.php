    ...
    <div class="featured container no-gutter">
        ...
        @foreach ($dtProduk as $isi)
            <div id="1" class="item new col-md-4">
              <a href="{{url('descSawi')}}">
                <div class="featured-item" style="padding:30px">
                  <img src="https://www.pikpng.com/pngl/b/163-1634687_icon-supermarket-cart-transprent-png-free-full-shopping.png" alt="" >
                  <h5>{{$isi->nama_barang}}</h5>
                  <h5>{{$isi->harga}}</h5>
                </div>
              </a>
            </div>
