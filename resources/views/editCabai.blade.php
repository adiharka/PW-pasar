      ...
      <div class="row posts" style="margin-top: 40px;">
        <div id="images" class="item new col-md-4">
            <div class="featured-item">
              <img src="https://deeres.id/wp-content/uploads/2020/07/cabe-rawit-mhanu-prentul-e1613459006497.jpg" alt="Cabe rawit" >
            </div>
          </a>
        </div>
          ...
          <a>
            <div class="featured-item">
              <h3>Deskripsi Produk:</h3>
                    <p>Cabe rawit merupakan sayuran hijau.</p>
                    <p>Dipetik langsung dari kebun.</p>
                    <p>Bebas pestisida.</p>
                    <h3>Harga Rp. 10.000,-</h3>
                    <p>Jumlah Stok : 25 Kg</p>
            </div>
          </a>
        </div>
        <div id="formedit" class="item low col-md-4">
          <a>
            <form action="#" method="POST">
              ...
              <p>Nama Barang :<input type="text" name="namaproduk" placeholder="Cabe Rawit"></p>
              <p>Deskripsi : <input type="text" name="deskripsi"></p>
              <p>Harga : <input type="number" name="hargabarang" placeholder="10.000"></p>
              <p>Jumlah stok : <input type="number" name="stok" placeholder="25" min="0"></p>
