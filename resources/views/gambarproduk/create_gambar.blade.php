        ...
        <div class="row">
          ...
          <div class="col-md-6">
            <div class="right-content"style="margin-right: 10px;">
              <div class="container" >
                <form id="contact" action="{{route('simpan_gambar')}}" method="post">
                {{csrf_field()}}
                  <div class="row">
                    <div class="col-md-12">
                      <fieldset>
                         <label for="fname"><b>Nama Produk</b></label>
                        <input name="nama_barang" type="text" class="form-control" id="nama_gambar" placeholder="Nama Produk" required="">
                      </fieldset>
                    </div>
                    <div class="col-md-12">
                      <fieldset>
                        <label for="Gambar"><b>Upload Gambar</b></label>
                        <input name="gambar" type="file" class="form-control" id="gambar" placeholder="Upload gambar produk" required="">
                      </fieldset>
                    </div>
