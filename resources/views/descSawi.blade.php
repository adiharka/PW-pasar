      ...
      <div class="row posts" style="margin-top: 40px;">
        <div id="images" class="item new col-md-4">
            <div class="featured-item">
              <img src="https://cdn.sindonews.net/dyn/620/makassar/news/2020/01/06/7/39316/ngeri-5-sayur-sehat-ini-bisa-sangat-jahat-dan-berbahaya-sor.jpg" alt="Sawi" >
            </div>
          </a>
        </div>
          ...
          <a>
            <div class="featured-item">
              <h3>Deskripsi Produk:</h3>
                    <p>Sawi merupakan sayuran hijau.</p>
                    ...
                    <p><h3>Review Pelanggan</h3></p>
                    <br>
                    
                    <tr>
                      <td><b>Chanyeol </b> </td>
                      <td>:</td><br>
                       <td>Bayamnya segar, harganya cukup murah</td>
                    </tr><br><br>
                     <tr>
                      <td><b>Sehun </b></td>
                      <td>:</td> <br><td>Pengirimannya cepat</td>
                    </tr><br><br>
                     <tr>
                      <td><b>Eren </b></td>
                      <td>:</td><br> <td> sangat memuaskan belanja disini</td>
                    </tr>
        ...
        <div id="formbeli" class="item low col-md-4">
          <a>
            <form action="formPembelian.html" method="POST">
              ...
              <a href="formPembelian.html"><input type="submit" value="Masukkan ke Keranjang" onclick="alert('Pesanan ditambahkan ke keranjang belanja');"></a>
            </form>
          </a>
        </div>
        </div>
