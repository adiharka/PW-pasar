      ...
      <div class="row posts" style="margin-top: 40px;">
        <div id="images" class="item new col-md-4">
            <div class="featured-item">
              <img src="https://img-z.okeinfo.net/okz/500/library/images/2018/07/16/v9unnsyz4o3qogieqzc5_12484.jpg" alt="Terong" >
            </div>
          </a>
        </div>
          ...
          <a>
            <div class="featured-item">
              <h3>Deskripsi Produk:</h3>
                    <p>Terong bukan merupakan sayuran hijau.</p>
                    <p>Dipetik langsung dari kebun.</p>
                    <p>Bebas pestisida.</p>
                    <h3>Harga Rp. 10.000,-</h3>
                    <p>Jumlah Stok : 13 Kg</p>
            </div>
          </a>
        </div>
        <div id="formedit" class="item low col-md-4">
          <a>
            <form action="#" method="POST">
              ...
              <p>Nama Barang :<input type="text" name="namaproduk" placeholder="Terong"></p>
              <p>Deskripsi : <input type="text" name="deskripsi"></p>
              <p>Harga : <input type="number" name="hargabarang" placeholder="10.000"></p>
              <p>Jumlah stok : <input type="number" name="stok" placeholder="13" min="0"></p>
