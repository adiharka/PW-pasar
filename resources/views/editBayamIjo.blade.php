      ...
      <div class="row posts" style="margin-top: 40px;">
        <div id="images" class="item new col-md-4">
            <div class="featured-item">
              <img src="https://st4.depositphotos.com/20616804/24952/i/600/depositphotos_249526346-stock-photo-a-bundle-of-fresh-spinach.jpg" alt="Bayam Hijau">
            </div>
          </a>
        </div>
          ...
          <a>
            <div class="featured-item">
              <h3>Deskripsi Produk:</h3>
                    <p>Bayam merupakan sayuran hijau.</p>
        ...
        <div id="formedit" class="item low col-md-4">
          <a>
            <form action="#" method="POST">
              ...
              <p>Nama Barang :<input type="text" name="namaproduk" placeholder="Bayam Hijau"></p>
