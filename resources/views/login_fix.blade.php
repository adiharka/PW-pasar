      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive" style="margin-top:50px;">
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item">
              <a class="nav-link" href="{{url('list_produk')}}">Products
                
              </a>
            </li>

              <li class="nav-item active">
              <a class="nav-link" href="login_fix">Login
                <span class="sr-only">(current)</span>
              </a>
            </li>
          <li>
            <a href="formPembelian" title="cart">
              <!-- <i class="fa fa-shopping-cart fa-sm" ></i> -->
              <i class="fa fa-shopping-cart fa-2x" style="margin-left: 20px;"></i>
            </a>
          </li>
          <div class="out" style="margin-left: 28px;">
              <li class="nav-item">
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="section-heading">
              ...
              <h1 style="font-size: 30pt;">Login</h1>
            </div>
          </div>
<!-- awal -->
<div class="container">
        <div class="col-md-4 offset-md-4 mt-5">
            <div class="card">
                ...
                <div class="card-footer">
                    ...
                    <p class="text-center">Belum punya akun? <a href="{{url('SignUp_fix') }}">Register</a> sekarang!</p>
                </div>
                </form>
            </div>
        </div>
